...
function getValueOfProperty(obj, prop) {
	val = obj[prop]
	console.log(obj[prop], obj.prop, prop)
	return val
}
...
function outside(temp, humi,clou) {
	if(temp > 80 && humi > 40) {
		return "I'm all sweat"
	} else if (temp < 40 && clou > 60) {
		return "I have icecicles"	
	} else if (temp > 80 && humi < 40 && clou < 20) {
		return "I'm literally in the desert"
	} else if (temp > 80 || humi > 50 || clou > 50) {
